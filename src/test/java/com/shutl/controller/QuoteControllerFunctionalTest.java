...
public class QuoteControllerFunctionalTest {
    ...
    @Test
    public void testBicyclePricing() throws Exception {
    ...
    @Test
    public void testMotorbikePricing() throws Exception {
        Quote quoteData = new Quote("SW1A1AA", "EC2A3LT", "motorbike");
        MvcResult result = this.mockMvc.perform(post("/quote")
                        .contentType("application/json")
                        .content(objectMapper.writeValueAsString(quoteData)))
                .andExpect(status().isOk())
    ...
    @Test
    public void testParcelCarPricing() throws Exception {
    ...
    @Test
    public void testSmallVanPricing() throws Exception {
    ...
    @Test
    public void testLargeVanPricing() throws Exception {
